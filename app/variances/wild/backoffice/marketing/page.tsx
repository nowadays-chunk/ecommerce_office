...
export default function WildMarketing() {
    const whisps = [
        { id: 'WL-MKT-101', code: 'STILLNESS_50', reward: '50% Seed Discount', status: 'Foraging' },
        { id: 'WL-MKT-102', code: 'VALLEY_GIFT', reward: 'Free_Mud_Mask', status: 'Stillness' },
        { id: 'WL-MKT-103', code: 'PLANET_LINK', reward: 'Priority_Earth_Access', status: 'Restored' },
    ];
            ...
            <aside className="w-80 bg-white border-r border-[#8b7e66]/10 p-12 flex flex-col justify-between shadow-2xl relative z-20">
                <div className="space-y-12">
                    ...
                    <nav className="space-y-8 text-[12px] font-bold uppercase tracking-widest text-[#8b7e66]">
                        ...
                        <a href="#" className="block text-[#2d2a22] border-b border-[#2d2a22] pb-2">TRIBAL_NODES</a>
            ...
            <main className="flex-1 p-24 space-y-32 h-screen overflow-y-auto relative bg-[#f4f1ea]">
                <header className="flex justify-between items-center bg-white/40 backdrop-blur-3xl p-16 rounded-[4rem] shadow-2xl border border-[#8b7e66]/10 group relative overflow-hidden">
                    ...
                    <div className="space-y-2 relative z-10">
                        <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#8b7e66] italic">PROMOTION_OVERSIGHT // STILL_SYNC_LIVE</p>
                        <h1 className="text-7xl font-light tracking-tighter uppercase leading-none italic text-[#2d2a22]">THE_REWARD_WHISPERS.</h1>
                    </div>
                    <button className="px-16 py-8 border border-[#2d2a22] text-[#2d2a22] text-[10px] font-bold uppercase tracking-widest rounded-2xl hover:bg-[#2d2a22] hover:text-[#f4f1ea] transition-all relative z-10">GENERATE_ROOT_CODE</button>
                </header>
                ...
                <section className="bg-white/40 backdrop-blur-3xl p-20 rounded-[5rem] shadow-2xl border border-[#8b7e66]/20 space-y-16 relative overflow-hidden group">
                    <div className="flex justify-between items-center text-[12px] font-bold uppercase tracking-widest text-[#8b7e66]/40">
                        <div className="space-x-12">
                            <button className="text-[#2d2a22] border-b border-[#2d2a22] pb-1">ALL_REWARDS</button>
                            <button className="hover:text-[#2d2a22] transition-colors">FORAGING</button>
                            <button className="hover:text-[#2d2a22] transition-colors">RESTORED</button>
                        </div>
                        <div className="animate-pulse italic">LISTENING_FOR_REWARD_WHISPERS...</div>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse border-separate border-spacing-y-4">
                        <thead>
                            <tr className="text-[12px] font-bold uppercase tracking-widest opacity-40 text-[#8b7e66]">
                                ...
                                <th className="px-10 pb-6">WHISPER_CODE</th>
                                <th className="px-10 pb-6">EARTH_REWARD</th>
                        ...
                        <tbody className="text-3xl font-light italic uppercase text-[#2d2a22]/80">
                            {whisps.map((w) => (
                                <tr key={w.id} className="bg-white/40 hover:bg-[#8b7e66]/10 transition-colors cursor-pointer group">
                                    ...
                                    <td className="p-10 font-bold tracking-widest uppercase text-[18px] text-[#2d2a22]">{w.code}</td>
                                    <td className="p-10 underline decoration-[#8b7e66]/20">{w.reward}</td>
                                    <td className="p-10 text-[#8b7e66] group-hover:animate-pulse">{w.status}</td>
                                    <td className="p-10 rounded-r-[4rem] text-right">
                                        <button className="text-xl bg-[#2d2a22] text-[#f4f1ea] px-8 py-2 rounded-2xl transform rotate-1">RESTORE_CODE</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
